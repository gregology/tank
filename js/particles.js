...
export class Particle {
    ...
    get alpha() { return Math.max(0, this.lifetime / this.maxLife); }
}
    ...
    emitExplosion(x, y) {
        ...
        for (let i = 0; i < 28; i++) {
            ...
            this._add(x, y, Math.cos(a) * s, Math.sin(a) * s,
                ...
                randomFloat(0.3, 1.0), randomFloat(2, 6));
        }
        // smoke
        for (let i = 0; i < 10; i++) {
            const a = randomFloat(0, Math.PI * 2);
            ...
            this._add(x, y, Math.cos(a) * s, Math.sin(a) * s,
                `rgb(${g},${g},${g})`, randomFloat(0.6, 1.5), randomFloat(3, 7));
        }
    }
    ...
    emitMuzzleFlash(x, y, angle) {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            this._add(x, y,
                ...
                randomFloat(0.08, 0.25), randomFloat(1, 3));
        }
    }
